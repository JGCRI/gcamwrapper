...
class Gcam(gcam_module.gcam):
    ...
    def get_current_period(self):
        ...
        :returns: The last period used in `run_to_period` whether it succeeded or failed
        """
    ...
    def get_current_year(self):
        ...
        :returns: The last period used in `run_to_period` whether it succeeded or failed but converted to year
        """
